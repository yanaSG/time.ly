...
const Profile = () => {
  ...
  const renderModalContent = () => {
    switch (modal) {
      ...
      case 'email':
        return (
            <div className="bg-white rounded-3xl shadow-xl p-10 min-w-[400px] max-w-[500px]">
            ...
            >
              ...
              <button type="submit"
                className="bg-cyan-700 text-white px-4 py-2 rounded cursor-pointer transition-colors duration-200 hover:bg-cyan-800"
              >
                Save
              </button>
              <button
                type="button"
                className="bg-gray-200 px-4 py-2 rounded cursor-pointer transition-colors duration-200 hover:bg-gray-300"
  ...
  return (
    <div className="w-full min-h-full flex flex-col md:flex-row justify-center items-start py-6 px-4 md:px-8 gap-8">
      <div className="flex-1 bg-white/80 rounded-3xl shadow-xl p-6 md:p-10 flex flex-col items-center md:items-start max-w-full">
        ...
        <button className="w-full md:w-auto bg-yellow-200 hover:bg-yellow-300 text-gray-800 font-semibold py-2 px-6 rounded-lg shadow transition mb-8 cursor-pointer"
        ...
        <div className="w-full">
          ...
          <div className="mb-6">
            <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-1">
              ...
              <button className="mt-2 md:mt-0 text-xs bg-yellow-100 hover:bg-yellow-200 text-gray-800 font-semibold py-1 px-3 rounded transition cursor-pointer"
          ...
          {modal === 'edit' && (
            ...
            >
              ...
              >
                ...
                <div className="flex gap-2 mt-8 justify-end">
                  <button type="submit" className="bg-cyan-700 hover:bg-cyan-800 text-white px-6 py-2 rounded-lg font-semibold shadow transition cursor-pointer">Save</button>
                  <button type="button" className="bg-gray-200 hover:bg-gray-300 text-gray-700 px-6 py-2 rounded-lg font-semibold transition cursor-pointer" onClick={() => setModal(null)}>Cancel</button>
                </div>
                {error && <p className="text-red-500 mt-2">{error}</p>}
              </form>
            </div>
